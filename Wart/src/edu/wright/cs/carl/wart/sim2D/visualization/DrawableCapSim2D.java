 ...
 * @author  Duane Bolick
 */
public class DrawableCapSim2D implements DrawableObjectSim2D
{
    ...
    private int centerX = ConstantsSim2D.CapDimensionsInPixels/2;
    private int centerY = ConstantsSim2D.CapDimensionsInPixels/2;
    
    private boolean isFirstRendering = true;
    private boolean receivedUpdate = false;    
    
    public DrawableCapSim2D(String objectID)
    {
    ...
    public void loadImages()
    {
        ...
        try {
            this.image = ImageIO.read(this.getClass().getResource("images/cap.png"));           
        }
        catch(IOException e) {
            e.printStackTrace();
            System.exit(1);
